            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                    ...
                    <a class=" sidebar-brand brand-logo" style="color: white; text-decoration: none;" href="{{route('HomePage')}}">
                        <h3 style="color: #2f5687 !important">Olimpus</h3>
                    </a>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="{{route('get_all_city')}}">
              <span class="menu-icon">
                <i class="mdi mdi-playlist-play"></i>
                    ...
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="{{route('all_sport_type')}}">
              <span class="menu-icon">
                <i class="mdi mdi-playlist-play"></i>
              </span>
                            <span class="menu-title">Виды спорта</span>
                        </a>
                    </li>


                    <li class="nav-item menu-items">
                        <?php $types = \App\Models\SportType::orderby('id', 'desc')->get(); ?>
                        <a class="nav-link collapsed" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
                <i class="mdi mdi-account-multiple-plus"></i>
              </span>
                            <span class="menu-title">Поля</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ui-basic" style="">
                            <ul class="nav flex-column sub-menu">
                                @foreach($types as $type)
                                <li class="nav-item"> <a href="{{route('filds', $type->id)}}" class="nav-link" >{{$type->name}}</a></li>
                                @endforeach
                              </ul>
                        </div>
                    </li>

    ...
    <div class="container-scroller">
        <div class="container-fluid page-body-wrapper full-page-wrapper">
            <div class="row w-100 m-0">
                <div style="background-image: url({{asset('pole.jpg')}})" class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
                        ...
                        <div class="card-body px-5 py-5">
                            ...
                            <form method="post" action="{{route('logined')}}" >
                                ...
                                <div class="text-center">
                                    <button type="submit" style="    background: #6a2b1473;" class="btn  btn-block enter-btn">Войти</button>
                                </div>
